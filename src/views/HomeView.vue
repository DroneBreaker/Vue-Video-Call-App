<template>
  <div class="mt-3">
    ...
    <div class="text-center font-bold">
      <h1 class="mb-4 text-4xl">Video Chat</h1>

      <p class="font-normal md:mx-[30rem] mx-[14rem] text-sm w-[14rem] mb-4">
        This app uses firebase for real time communication and webRTC to create
